...
Was <- c("Wahrscheinlichkeiten", "Modell- und Datenkomponenten", "Parameterschätztechniken")
...
Bayesianer <-  c("Mass für Informationsgehalt unabhängig von Stichprobengrösse",
                 "Unterscheidung zwischen unbekannten und bekannten Grössen, unabhängig ob Parameter oder Daten",
                 "MCMC Zufallszahlen zur Approximation der gewünschten a posteriori Verteilungen")
#knitr::kable
pander::pandoc.table(data.frame(Was           = Was,
