...
wobei: $\mathbf{y}$: Vektor mit phänotypischen Beobachtungen, $\mathbf{b}$: Vektor mit fixen Effekten, $\mathbf{X}$: Inzidenzmatrix, welche fixe Effekte den Beobachtungen zuordnet, $\mathbf{u}$: Vektor von Zuchtwerten
